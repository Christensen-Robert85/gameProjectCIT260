...
import gameproject1.userName;

/**
 *
 * @author Robert
 */
public class nameFrameJ extends javax.swing.JFrame implements Serializable {
    ...
    private void startGame() {
        userName.promptName(this.jNameTextField.getText());
        ...
        try {
            ...
            System.out.println(enumPackage.errorHandle.FATAL_ERROR.getMessage()
    ...
    public static void setNameOfPlayer(String nameOfPlayer) {
        nameFrame.nameOfPlayer = nameOfPlayer;
    }
