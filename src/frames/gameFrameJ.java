...
import keys.mysteryWord;

/**
 *
 * @author Robert
 */
public class gameFrameJ extends javax.swing.JFrame implements Serializable {
    ...
    /**
     * Creates new form gameFrameJ
     */
    public gameFrameJ() throws IOException {
        this.setStatus(status.PLAYING);
        
        this.mysteryWord = new mysteryWord();
        initComponents();
        
        if (!nameFrameJ.getNameOfPlayer().isEmpty()) {
            this.jGuessWordLabel.setText(nameFrameJ.getNameOfPlayer() + ", guess this word:");
        }
    ...
    private void displayWinningMessage() {
        wonGameFrame wonGameFrame = new wonGameFrame();
        wonGameFrame.setVisible(true);
        this.dispose();
    }

    private void displayLosingMessage() {
        lostGameFrame lostGameFrame = new lostGameFrame();
        lostGameFrame.setVisible(true);
        this.dispose();
    }
